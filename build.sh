...
# Set version on custom files

echo "Cyb3rb0b $KALI_VERSION \n \l" > kali-config/common/includes.chroot/etc/issue

sed "s/__VERSION__/${KALI_VERSION}/g" kali-config/common/includes.chroot/etc/os-release.in > kali-config/common/includes.chroot/etc/os-release
